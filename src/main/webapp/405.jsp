...
<div id="page">
	...
	<div id="container">
		...
		<h1>Methode nicht gestattet</h1>
		<h2>Fehlercode ${pageContext.errorData.statusCode}</h2>
		<p>
			Die HTTP-Methode <strong>${pageContext.request.method}</strong> ist für die URI 
			<strong>${pageContext.errorData.requestURI}</strong> nicht gestattet.
		</p>
